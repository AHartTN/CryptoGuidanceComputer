 ...
 * @description Performance dashboard for Apollo DSKY Crypto Guidance Computer.
 * Displays system metrics, alerts, and resource utilization.
 *
...
// Utility to map status color to a class
 ...
 * Renders the performance dashboard with metrics, alerts, and system info.
 *
 * @param {IPerformanceDashboardProps} props - Dashboard props.
 * @returns {JSX.Element} The rendered performance dashboard.
 */
export const PerformanceDashboard: React.FC<IPerformanceDashboardProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "metrics" | "alerts" | "system"
  >("overview");
  ...
  const getStatusColor = useCallback(
    (value: number, thresholds: { warn: number; error: number }): string => {
      if (value >= thresholds.error) return "#FF0080";
      if (value >= thresholds.warn) return "#FF8000";
      return "#00FF41";
    },
    [],
  );
      ...
      <div className="performance-cards">
        <div className="performance-card">
          <div className="card-header">
            <h4>Response Time</h4>
            <span
              className={`card-value ${getStatusClass(performance.responseTime, {
                warn: 3000,
                error: 5000,
              })}`}
            >
          ...
          <div className="card-details">
            <div className="detail-item">
              ...
              <span>
                {formatDuration(
                  performance.stats[MetricType.RESPONSE_TIME]?.average || 0,
                )}
              </span>
            </div>
            <div className="detail-item">
              ...
              <span>
                {formatDuration(
                  performance.stats[MetricType.RESPONSE_TIME]?.percentile95 ||
                    0,
                )}
              </span>
            </div>
        ...
        <div className="performance-card">
          <div className="card-header">
            <h4>Memory Usage</h4>
            <span
              className={`card-value ${getStatusClass(performance.memoryUsage, {
                warn: 70,
                error: 85,
              })}`}
            >
          ...
          <div className="card-details">
            ...
            <div className="detail-item">
              ...
              <span>
                {formatBytes(
                  (performance.systemResources as ISystemResourceInfo)
                    ?.memoryUsage?.used || 0,
                )}
              </span>
            </div>
        ...
        <div className="performance-card">
          <div className="card-header">
            <h4>Error Rate</h4>
            <span
              className={`card-value ${getStatusClass(performance.errorRate, {
                warn: 3,
                error: 5,
              })}`}
            >
          ...
          <div className="card-details">
            <div className="detail-item">
              ...
              <span>
                {performance.stats[MetricType.ERROR_RATE]?.count || 0}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="system-info">
        ...
        <div className="info-grid">
          ...
          <div className="info-item">
            ...
            <span
              style={{
                color: perfConfig.enableMonitoring ? "#00FF41" : "#FF0080",
              }}
            >
          ...
          <div className="resources-grid">
            <div className="resource-item">
              ...
              <div className="resource-bar">
                <div
                  ...
                  data-width={`${(performance.systemResources as ISystemResourceInfo).memoryUsage.percentage}%`}
                  data-color={getStatusColor(
                    (performance.systemResources as ISystemResourceInfo)
            ...
            <div className="resource-item">
              ...
              <div className="resource-bar">
                <div
                  className="resource-fill"
                  data-width={`${(performance.systemResources as ISystemResourceInfo).cpuUsage}%`}
                  data-color={getStatusColor(
                    (performance.systemResources as ISystemResourceInfo)
                      .cpuUsage,
                    { warn: 70, error: 85 },
      ...
      <div className="configuration-info">
        ...
        <div className="config-grid">
          ...
          <div className="config-item">
            ...
            <span>
              {formatDuration(perfConfig.alertThresholds.responseTime)}
            </span>
          </div>
          <div className="config-item">
      ...
      <div className={`performance-dashboard ${compactMode ? "compact" : ""}`}>
        ...
        <div className="dashboard-footer">
          <div className="footer-info">
            ...
            <span>•</span>
            <span>
              Status: {performance.isMonitoring ? "MONITORING" : "INACTIVE"}
            </span>
            <span>•</span>
